...
function showBalance(acc){acc&&alert(numeral(acc.balance).divide(1e18).format("0,0.00")+" ETH")}!function(){var accounts=null,$checkForm=$("#ether-checker");$checkForm.submit(function(e){e.preventDefault();var addr=$checkForm.find("input[name=address]").val();addr&&("0x"==addr.slice(0,2)&&(addr=addr.slice(2)),addr=addr.toLowerCase(),null==accounts?$.getJSON("/images/mainnet.json",function(data){accounts=data.alloc,showBalance(accounts[addr])}):showBalance(accounts[addr]))})}(),$(document).ready(function(){$(".home-slider").slick({dots:!0,infinite:!0,speed:500,fade:!0,cssEase:"linear",prevArrow:$(".prev"),nextArrow:$(".next")}),$(document).on("mousewheel",function(){var structure=$("#structure"),offsetScrollStructure=$(document).scrollTop(),offsetStructure=.7*structure[0].offsetTop;console.log(offsetScrollStructure,offsetStructure),offsetScrollStructure>offsetStructure?(structure.find(".title").addClass("show"),structure.find(".description").addClass("show")):(structure.find(".title").removeClass("show"),structure.find(".description").removeClass("show")),offsetScrollStructure>1.4*offsetStructure?structure.find("img").addClass("show"):structure.find("img").removeClass("show")})});
