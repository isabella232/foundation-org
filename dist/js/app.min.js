...
function showBalance(acc){acc&&alert(numeral(acc.balance).divide(1e18).format("0,0.00")+" ETH")}!function(){var accounts=null,$checkForm=$("#ether-checker");$checkForm.submit(function(e){e.preventDefault();var addr=$checkForm.find("input[name=address]").val();addr&&("0x"==addr.slice(0,2)&&(addr=addr.slice(2)),addr=addr.toLowerCase(),null==accounts?$.getJSON("/images/mainnet.json",function(data){accounts=data.alloc,showBalance(accounts[addr])}):showBalance(accounts[addr]))})}(),$(document).ready(function(){function animate(){var animate=$(".animate"),offset=$(window).scrollTop();$(animate).each(function(){var itemOffset=$(this).offset().top-$(window).innerHeight();offset>itemOffset?$(this).addClass("show"):$(this).removeClass("show")})}function indicator(){var indicator=$(".indicator"),offset=$(window).scrollTop(),documentHeight=$(document.body).height()-$(window).innerHeight();indicator.css("width",100*offset/documentHeight+"%")}$(".home-slider").slick({dots:!0,infinite:!0,speed:500,fade:!0,cssEase:"linear",prevArrow:$(".prev"),nextArrow:$(".next")}),animate(),indicator(),$(window).on("scroll",function(){animate(),indicator()}),$(function(){$("#map").googleMap({zoom:15,overviewMapControl:!0,streetViewControl:!0,scrollwheel:!0,mapTypeControl:!0,coords:[51.58731,4.762877]}),$("#map").addMarker({coords:[51.58731,4.762877],title:"BANKEX Foundation",id:"marker1"})}),$(function(){$("a.page-scroll").bind("click",function(event){var $anchor=$(this);$("html, body").stop().animate({scrollTop:$($anchor.attr("href")).offset().top},1500,"easeInOutExpo"),event.preventDefault()})})});
