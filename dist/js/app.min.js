...
function showBalance(acc){acc&&alert(numeral(acc.balance).divide(1e18).format("0,0.00")+" ETH")}!function(){var accounts=null,$checkForm=$("#ether-checker");$checkForm.submit(function(e){e.preventDefault();var addr=$checkForm.find("input[name=address]").val();addr&&("0x"==addr.slice(0,2)&&(addr=addr.slice(2)),addr=addr.toLowerCase(),null==accounts?$.getJSON("/images/mainnet.json",function(data){accounts=data.alloc,showBalance(accounts[addr])}):showBalance(accounts[addr]))})}(),$(document).ready(function(){function animate(){var structure=$("#structure"),offset=$(document).scrollTop(),offsetStructure=.7*structure[0].offsetTop;offset>offsetStructure?(structure.find(".title").addClass("show"),structure.find(".description").addClass("show")):(structure.find(".title").removeClass("show"),structure.find(".description").removeClass("show")),offset>1.4*offsetStructure?structure.find("img").addClass("show"):structure.find("img").removeClass("show");var projects=$("#projects"),offsetProjects=.8*projects[0].offsetTop;offset>offsetProjects?projects.find(".title").addClass("show"):projects.find(".title").removeClass("show"),offset>1.1*offsetProjects?projects.find(".row:first-child .col-md-6").addClass("show"):projects.find(".row:first-child .col-md-6").removeClass("show"),offset>1.25*offsetProjects?projects.find(".row:last-child .col-md-6").addClass("show"):projects.find(".row:last-child .col-md-6").removeClass("show")}$(".home-slider").slick({dots:!0,infinite:!0,speed:500,fade:!0,cssEase:"linear",prevArrow:$(".prev"),nextArrow:$(".next")}),animate(),$(document).on("mousewheel",function(){animate()})});
